...
const AppLogoMark = ({ className = "" }: AppLogoMarkProps) => {
  return (
    ...
    >
      <defs>
        <linearGradient id="app-logo-bg" x1="10" y1="8" x2="56" y2="56" gradientUnits="userSpaceOnUse">
          <stop stopColor="#34D399" />
          <stop offset="0.55" stopColor="#10B981" />
          <stop offset="1" stopColor="#0F766E" />
        </linearGradient>
        <linearGradient id="app-logo-loop" x1="18" y1="16" x2="48" y2="50" gradientUnits="userSpaceOnUse">
          <stop stopColor="#ECFDF5" />
          <stop offset="1" stopColor="#A7F3D0" />
        </linearGradient>
      </defs>

      <rect x="4" y="4" width="56" height="56" rx="18" fill="url(#app-logo-bg)" />
      <rect x="4" y="4" width="56" height="56" rx="18" stroke="rgba(255,255,255,0.18)" strokeWidth="1.2" />

      <circle cx="32" cy="32" r="15.5" stroke="url(#app-logo-loop)" strokeWidth="5" strokeLinecap="round" strokeDasharray="62 16" />
      ...
      />
      <path
        d="M46.6 24.5l4.9 1.1-2.4-4.4-2.5 3.3Z"
        fill="#F0FDF4"
      />
      <path
        d="M17.4 39.5l-4.9-1.1 2.4 4.4 2.5-3.3Z"
        fill="#F0FDF4"
      />
